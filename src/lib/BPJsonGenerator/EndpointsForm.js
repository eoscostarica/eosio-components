...
const EndpointsForm = ({ currentNode, handleOnChange }) => {
  ...
  return (
    <>
      ...
      <TextField
        style={{
          display: !(NODE_EXTRA_KEYS[currentNode.node_type]?.indexOf('p2p_endpoint') > -1) ? 'none' : undefined
        }}
      ...
      <TextField
        ...
        style={{
          display: !(NODE_EXTRA_KEYS[currentNode.node_type]?.indexOf('api_endpoint') > -1) ? 'none' : undefined
        }}
        variant="outlined"
        label="API Endpoint"
      ...
      <TextField
        style={{
          display: !(NODE_EXTRA_KEYS[currentNode.node_type]?.indexOf('ssl_endpoint') > -1) ? 'none' : undefined
        }}
