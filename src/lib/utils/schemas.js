...
const locationSchema = {
  ...
  country: {
    isValid: countryValidation,
    isRequired: true,
    message: 'The country code must be two letters'
  },
  latitude: {
    isValid: latitudeValidation,
    isRequired: false,
    message: 'The latitude range is between -90 and 90'
  },
  longitude: {
    isValid: longitudeValidation,
    isRequired: false,
    message: 'The longitude range is between -180 and 180'
  }
}
const nodeSchema = {
  node_type: { isValid: requiredValidation, isRequired: true },
  full: { isValid: isBoolean, isRequired: false },
  location: {
    isValid: (obj) => validate(obj, locationSchema),
    isRequired: false
  },
...
const orgSchema = {
  ...
  website: {
    isValid: requiredUrlValidation,
    isRequired: true,
    message: 'Invalid URL'
  },
  email: {
    isValid: emailInputValidation,
    isRequired: true,
...
export { locationSchema, nodeSchema, orgSchema, bpSchema }
